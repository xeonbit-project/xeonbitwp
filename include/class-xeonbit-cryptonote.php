<?php
/*
  Copyright (c) 2018 Xeonbit-Integrations
*/
...
require_once('class-xeonbit-base58.php');

class Xeonbit_Cryptonote
{
    protected $ed25519;
    public function __construct()
    {
        $this->ed25519 = new ed25519();
        $this->base58 = new Xeonbit_base58();
        $this->address_prefix = XEONBIT_GATEWAY_ADDRESS_PREFIX;
        $this->address_prefix_integrated = XEONBIT_GATEWAY_ADDRESS_PREFIX_INTEGRATED;
    }
    ...
    /*
     * Create a valid base58 encoded Xeonbit address from public keys
     *
     * @param string Public spend key
     * @param string Public view key
     *
     * @return string Base58 encoded Xeonbit address
     */
...
/*
 * Decode a base58 encoded Xeonbit address
 *
 * @param string A base58 encoded Xeonbit address
 *
 ...
 */
    ...
    /*
     * Generate a Xeonbit address from seed
     *
     * @param string Hex string to use as seed
     *
     * @return string A base58 encoded Xeonbit address
     */
